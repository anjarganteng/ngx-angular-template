...
export class ProductListComponent {
  ...
  getAllProduct(){
    ...
    this.api.post(this.api.urlBase+this.api.urlProduct+'/search', requestJson).subscribe((res: any) => {
      this.data =  res.data;
  ...
  // actionDelete(event): void {
  //   if (window.confirm('Are you sure you want to delete?')) {
  //     // event.confirm.resolve();
  //     this.validation.showToastFailed('Product is not permitted to be deleted !');
  //   } else {
